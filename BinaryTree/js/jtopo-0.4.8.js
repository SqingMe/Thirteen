...
function(JTopo) {
    ...
    function toJson(a) {
        ...
        c = "text,elementType,x,y,width,height,visible,alpha,rotate,scaleX,scaleY,fillColor,shadow,transformAble,zIndex,dragable,showSelected,font,fontColor,textPosition,textOffsetX,textOffsetY".split(","),
        d = "{";
        d += "frames:" + a.frames,
        d += ", scenes:[";
...
function(a) {
    ...
    function c() {
        this.initialize = function() {
            ...
            this.isMouseOver = !1;
            var a = "dragable,showSelected,isMouseOver".split(",");
            this.serializedProperties = this.serializedProperties.concat(a)
        },
        this.initialize(),
        this.paintSelected = function(a) {
            0 != this.showSelected && (a.save(), a.beginPath(), a.strokeStyle = "rgba(245,112,63, 0.9)", a.fillStyle = "rgba(245,112,63,0.7)", a.rect( - this.width / 2 - 3, -this.height / 2 - 3, this.width + 6, this.height + 6), a.fill(), a.stroke(), a.closePath(), a.restore())
        },
    ...
    function d() {
        ...
        this.selectedAllStepNode = function(b) {
            d.prototype.selectedHandler.apply(this, arguments),
            this.selectedSize = {
                width: this.width,
                height: this.height
            },
            b.mode == a.SceneMode.edit && (this.editAble = !0)
        },
        this.unselectedHandler = function() {
...
function(a) {
    function b(c) {
        this.initialize = function(c) {
            ...
            this.type = null;
            this.blocked = false;
            var d = "type,blocked,text,font,fontColor,textPosition,textOffsetX,textOffsetY,borderRadius".split(",");
        ...
        this.paintStatus = function(a){
            if (false === this.status || true === this.status) {
                a.beginPath();
                var x = this.width *1/ 3 ,
                    y = -this.height*1 / 3 ,
                    radius = this.width/8;
                    a.lineWidth = radius/8;
                    a.lineJoin="round";
                    if(this.status){
                        a.fillStyle = "#00FF00";
                        ...
                        a.fill();
                        a.beginPath();
                        a.moveTo(x-radius*0.625,y-radius*0.25);
                        a.lineTo(x-radius*0.125,y+radius*0.375);
                        a.lineTo(x+radius*0.625,y-radius*0.5);
                        a.stroke();
                    }else{
                        a.fillStyle = "#FF0000";
                        a.arc(x,y,radius,0,2*Math.PI);
                        a.fill();
                        a.beginPath();
                        a.moveTo(x-radius*0.6,y-radius*0.6);
                        a.lineTo(x+radius*0.6,y+radius*0.6);
                        a.moveTo(x+radius*0.6,y-radius*0.6);
                        a.lineTo(x-radius*0.6,y+radius*0.6);
                        a.stroke();
                    }
    ...
    function f(a) {
        ...
        this.paintSelected = function(a) {
            a.save(),
            a.beginPath(),
            a.strokeStyle = "rgba(252,203,66, 0.9)",
            a.fillStyle = "rgba(252,203,66,0.7)",
    ...
    function f(b, c, g) {
        ...
        this.initialize = function(b, c, d) {
            if (f.prototype.initialize.apply(this, arguments), this.elementType = "link", this.zIndex = a.zIndex_Link, 0 != arguments.length) {
                ...
                this.path = [];
                var e = "unconditional,evaluation,enabled,text,font,fontColor,lineWidth,lineJoin,arrowsRadius".split(",");
        ...
        this.paintArrow = function(b, c, d) {
            ...
            if(this.doubleArrow){
                b.beginPath();
                b.moveTo(o.x+x1, o.y+y1),
                b.lineTo(m+x1, n+y1),
                b.lineTo(p.x+x1, p.y+y1),
                b.stroke(),
                b.closePath()
            }
        },
