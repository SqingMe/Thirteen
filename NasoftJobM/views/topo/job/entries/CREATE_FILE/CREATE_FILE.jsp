			...
			<table align="center">
				<tr>
					...
					<td colspan="2"><input class="easyui-textbox"
						id="CREATE_FILE_task_name" name="CREATE_FILE_task_name"
						style="width: 200px;" /></td>
				</tr>
				<tr>
					<td align="right">文件名:</td>
					<td><input class="easyui-textbox"
						id="CREATE_FILE_task_filename" style="width: 140px;" /></td>
					<td align="left"><a id='CREATE_FILE_transition'
						class='easyui-linkbutton' style="width: 60px">浏览</a> <input
						type="hidden" id="CREATE_FILE_task_filename_h"></td>
				</tr>
				<tr>
					<td align="right">如果文件存在则创建失败:</td>
					<td colspan="2"><input type="checkbox"
						id="CREATE_FILE_task_failurefile" /></td>
				</tr>
			</table>
		</div>
		<div region="south" style="padding: 10px;">
			<div style="margin: auto; text-align: center">
				<a class="easyui-linkbutton" id="CREATE_FILE_ok"
					style="width: 60px;">确定</a> <a class="easyui-linkbutton"
					id="CREATE_FILE_cancel" style="width: 60px;">取消</a>
			</div>
		</div>
	</div>
</div>
