...
<div id="InsertUpdate" class="easyui-window" title="插入 / 更新"
	...
	<div class="easyui-layout" fit="true">
			...
			<table style="margin-left: 280px;">
				<tr>
					...
					<td><input class="easyui-textbox"
						nama="step_name_InsertUpdate" id="step_name_InsertUpdate"
		...
		<div region="center">
			<div id="InsertUpdate_tabs" class="easyui-tabs"
							...
							<fieldset>
								...
								<table style="margin-left: 400px;">
									<tr>
										...
										<td><input id="server_conner_InsertUpdate"
									...
									<tr>
										<td>模式名称</td>
										<td><input class="easyui-textbox"
											id="goal_model_InsertUpdate" style="width: 600px;" /></td>
									</tr>
									<tr>
										<td>目标表</td>
										<td><input class="easyui-textbox"
											id="goal_surface_InsertUpdate" style="width: 600px;" /></td>
									</tr>
									<tr>
										<td>提交数量</td>
										<td><input class="easyui-textbox"
											id="goal_submit_InsertUpdate" style="width: 600px;" /></td>
									</tr>
									<tr>
										<td>不执行任何更新</td>
										<td><input type="checkbox" id="cache_InsertUpdate" /></td>
									</tr>
								</table>
							</fieldset>
						</form>
				...
				<div title="用来查询表关键字" style="display: none;">
					<table id='InsertUpdate_condition_table' class='easyui-datagrid'
						data-options="singleSelect:true,fit:true">
					</table>
				</div>

				<div title="更新字段" style="display: none;">
					<table id='InsertUpdate_output_table' class='easyui-datagrid'
						data-options="singleSelect:true,fit:true">
					</table>
				</div>
			</div>
		...
		<div region="south" border="true" style="padding: 10px;">
			<div style="margin: auto; text-align: center;">
				<a class="easyui-linkbutton" id="InsertUpdate_ok"
					style="width: 100px;">确定</a> <a class="easyui-linkbutton"
					id="InsertUpdate_cancel" style="width: 100px;">取消</a>
			</div>
		</div>
		<!--底部-->
